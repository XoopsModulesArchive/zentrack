...
?>
  <br>
  <blockquote>
  <span class='bigBold'>Features of <?php echo $zen->getSetting("system_name"); ?></span>

  <p><b>(This page has yet to fully expand into what it should be.  Will be 
	done before the live (2.1) release of zenTrack.)</b></p>
   
  <p>This site, <?php echo $HTTP_HOST." / ".$zen->getSetting("system_name"); ?>, is an open source variant of the 
     <a href='http://sourceforge.net/projects/zentrack'>zenTrack project</a>. It
     is protected under the <a href='<?php echo $helpUrl?>/gpl.php'>GPL 2.0 Liscence</a>.</p>
  ...
  <ul>
    <li><a href='<?php echo $helpUrl?>/features.php'>Overiew, Capabilities and Limitations</a>
    <li><a href='<?php echo $helpUrl?>/future.php'>Future Plans for zenTrack Project</a>
  </ul>
