...
<tr>
  <td class='cell'>
    ...
    <p>Bins are maintained by going to 
      ...
      <?php echo tr('Data Types'); ?> -&gt;
      <?php echo tr('Bins'); ?></b></p>
    
    <p>Access to bins is controlled by going to: 
      <br><b><?php echo tr('Admin'); ?> -&gt;
      <?php echo tr('Edit Users'); ?> -&gt;
      Find User to Edit  -&gt;
      Access Link</b></p>
  </td>
</tr>
...
<tr>
  <td class='cell'>
    ...
    <a href='<?php echo $adminUrl?>/data_types.php'>next section</a>) 
...
<tr>
  <td class='cell'>
    ...
    <p>We start our quest by heading to 
      <b><?php echo ('Admin'); ?> -&gt;
      <?php echo ('Settings Administration'); ?> -&gt;
      <?php echo ('Configuration Settings'); ?></b>.  
