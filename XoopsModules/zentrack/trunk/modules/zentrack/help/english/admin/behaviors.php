...
<tr>
  <td class='cell'>
    ...
    behavior will come from a <?php echo tr('Data Group'); ?> (discussed in the 
    <a href='<?php echo $adminUrl?>/data_groups.php'>previous section</a>), and can
    ...
    '<?php echo tr('Field to change'); ?>' for more details.
  </td>
</tr>
<tr>
...
<tr>
  <td class='cell'>
    Behaviors can be found on the nav menu:  <?php echo tr('Admin'); ?> 
    -&gt; <?php echo tr('Settings Administration'); ?> 
    -&gt; <?php echo tr('Edit Behaviors'); ?>.
    
    <p>Choosing the '<?php echo tr('New'); ?>' button will bring up the form to create
    new behaviors.
...
<tr>
  <td class='cell'>
    ...
    <tr>
      <td class='bars'><?php echo tr('Field to change'); ?></td>
      <td class='bars'>
        ...
        of the <?php echo tr('Sort Order'); ?>(above)!
        
        <p>If the <?php echo tr('Field to change'); ?> is set to a <b>text field</b> (a form field
        which can only hold one entry) the first element of the list created will
        be placed here and the rest will be discarded.
      </td>
    </tr>
    <tr>
      <td class='bars'><?php echo tr('Field is enabled'); ?></td>
      <td class='bars'>
    ...
    <tr>
      <td class='bars'><?php echo tr('Match Type'); ?></td>
      <td class='bars'>
        Used to determine how we will match rules for this behavior.  
        
        <p>If this is set to <b>'<?php echo tr('Match Any'); ?>'</b>, then the rules for 
        this behavior are evaluated using an 'OR' condition.  Thus, matching 
        any one rule will trigger the behavior.
        
        <p>If this is set to <b>'<?php echo tr('Match All'); ?>'</b>, then the rules for
...
<tr>
  <td class='cell'>
     ...
     true (based on the '<?php echo tr('Match Type'); ?>' property), then this behavior
     ...
     <p>The '<?php echo tr('Compare Value'); ?>' field may be left blank to match empty
     strings or null values.  The '<?php echo tr('Sort Order'); ?>' is used to determine
