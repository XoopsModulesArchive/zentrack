...
<tr>
  <td class='cell'>
    ...
    <br><?php echo tr('Admin'); ?> -&gt; <?php echo tr('Ticket Administration'); ?> -&gt; <?php echo tr('Edit Variable Fields'); ?>.
  </td>
</tr>
<tr>
  ...
  <td class='cell'>
    ...
    page and how to configure them:
     <table width='80%' align='center'>
      ...
      <tr>
        <td class='bars'><?php echo tr('Field Name'); ?></td>
        <td class='bars'>
          must match column in database
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Field Label'); ?></td>
        <td class='bars'>
          text to display to users of the system
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Order'); ?></td>
        <td class='bars'>
          display order for the variable fields (defaults to label)
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Default'); ?></td>
        <td class='bars'>
          default value for this field (a valid string)
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Required'); ?></td>
        <td class='bars'>
          is this field required?
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Projects'); ?></td>
        <td class='bars'>
          display this field in projects 
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Tickets'); ?></td>
        <td class='bars'>
          display this field in tickets
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Searches'); ?></td>
        <td class='bars'>
          show this field in search window
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Lists'); ?></td>
        <td class='bars'>
          not used (reserved for future use)
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Custom'); ?></td>
        <td class='bars'>
          show this field in custom tab
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('Details'); ?></td>
        <td class='bars'>
          show this field in details tab
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('New'); ?></td>
        <td class='bars'>
          show this field in '<?php echo tr('Create New'); ?>' window
        </td>
      </tr>
      <tr>
        <td class='bars'><?php echo tr('JS Validation'); ?></td>
        <td class='bars'>
          not used (reserved for future use)
        </td>
      </tr>
