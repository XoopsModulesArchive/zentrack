...
<form method="post" action="<?php echo $rootUrl?>/misc/homebin.php">

<table width="300" cellpadding="5">
<tr>
  <td colspan="2" class="subTitle" align="center" height="20">
    <b><?php echo tr("Change Your Default Bin"); ?></b>
  </td>
</tr>
<tr>
  <td class="bars">
    <b><?php echo tr("New Default Bin"); ?></b>
  </td>
  <td class="bars">
    <select name="homebin">
<?php
...
<tr>
  <td class="bars" colspan="2">
    <input type="submit" value="<?php echo tr("Update Bin"); ?>" class="submit">
  </td>
</tr>
</table>
