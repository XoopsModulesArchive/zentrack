  ...
  <tr>
   <td><table
    ...
    <tr>
	  ...
	  <tr>
	   <td class="headerCell" colspan="2" width="50%"><?php echo uptr("Info"); ?></td>
	   <td class="headerCell"  width="50%"><?php echo uptr("Address"); ?></td>
	  </tr>
	  <tr>
	   <td class="bars indent boxpad" colspan="2">
	   <?php 
	   if(!empty($office)){ echo $zen->ffv($office)."<br>";}
	   if(!empty($email)){?><A HREF="mailto:<?php echo $zen->ffv($email); ?>"><?php echo $zen->ffv($email); ?></A><br><?}
	   if ($website == "http://" or $website == "") {
		 echo "<br>";  
		 } else {
	   if(!empty($website)){?><A TARGET="_blank" HREF="<?php echo $zen->ffv($website); ?>"><?php echo $zen->ffv($website); ?></A><?}}?>
	   </td>
	  ...
	  <tr>
	   <td class="headerCell" colspan="2"><?php echo uptr("Numbers"); ?></td> 
	  </tr>
	  <tr>
	   <td class="bars small" width="20%"><?php echo tr("Telephone no"); ?>:</td>  
	   <td class="bars small" width='30%'><?php echo $telephone? $zen->ffv($telephone) : '&nbsp;'?></td>
	  </tr>
	  <tr>
	   <td class="bars small"><?php echo tr("Fax no"); ?>:</td> 
	   <td class="bars small"><?php echo $fax? $zen->ffv($fax) : '&nbsp;'?></td> 
	  </tr>
	  <?php
 if(!empty($description)) {
?>	  
	  <tr>
	   <td class="headerCell" colspan="3"><?php echo uptr("Comments"); ?></td>  
	  </tr>
	  <tr>
	   <td class="bars small" colspan="3"><?php echo  $zen->ffvText($description) ?></td>
	  </tr>
<?php
}
?>
