...
<img src="<?php echo $tutImageUrl?>/nav_tickets.gif" 
     alt="An image of the ticket link on the nav"
     height="235" width="157" align='left'>

<p><b>Finding a Ticket</b></p>

<p>Clicking on the '<?php echo tr("Tickets"); ?>' link in the nav bar (shown on the left) 
...
<p align='center'><img src="<?php echo $tutImageUrl?>/ticket_list.gif" 
...
'<?php echo tr("Search"); ?>' link on the left-hand menu.  We won't cover the search
...
<img src="<?php echo $tutImageUrl?>/current_bin.gif" 
     alt="An image of the current bin pulldown"
     height="291" width="212" align='right'>

<p>You can also filter the list of tickets using the '<?php echo tr("Current Bin"); ?>' pulldown
in the navigation menu.  This will reduce the list to show only the tickets which
are within the <?php echo tr("Bin"); ?> you have picked.

<p>A Bin is a way to group tickets.  Some companies use a <?php echo tr("Bins"); ?> to describe
...
<img src="<?php echo $tutImageUrl?>/ticket_view.gif" 
