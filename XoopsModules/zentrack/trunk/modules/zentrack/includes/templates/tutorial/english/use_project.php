...
the '<?php echo tr('Project'); ?>' link in the nav bar to pull up the list, and select
the project you wish to view.

<p>The view for a project is very similar to the ticket view.  There is an
additional tab called the <b>'<?php echo tr('Tasks'); ?>'</b> tab, which you can use
to view all of the tickets or sub-projects which have been assigned to this
project.

<p>You can search for projects under the '<?php echo tr('Search'); ?>' link on the nav
menu just as you would for tickets.  Simply select the type <?php echo tr('Project'); ?>
to filter your list to projects only.

<p><b>Creating A Project</b></p>

<p>Create a project by choosing the '<?php echo tr('Project'); ?>' link from the nav menu
and then choosing the expanded option for '<?php echo tr('Create New'); ?>'.
