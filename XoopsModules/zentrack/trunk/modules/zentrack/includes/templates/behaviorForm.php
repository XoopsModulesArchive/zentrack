...
if( !ZT_DEFINED ) { die("Illegal Access"); }
  ...
  $url = ($td)? "edit" : "add";
?>
<form method="post" action="<?php echo $rootUrl?>/admin/<?php echo $url?>BehaviorSubmit.php">
...
<tr>
  <td colspan="2" class="subTitle">
    <?php echo tr("Behavior Information"); ?> (<?php echo tr("* = required"); ?>)
  </td>
</tr>  
<tr>
  <td class="bars" width='125'>
    <?php echo tr("Behavior Name"); ?>*
  </td>
  <td class="bars">
    <input type="text" name="NewBehaviorName" value="<?php echo strip_tags($behavior['behavior_name']); ?>" size="40" maxlength="100">
  </td>
</tr>
<tr>
  <td class="bars">
...
<tr>
  <td class="bars">
    <?php echo tr("Sort Order"); ?>
  </td>
  <td class="bars">
    <input type="text" name="NewSortOrder" value="<?php echo strip_tags($behavior['sort_order']); ?>" size="40" maxlength="255">
    <div class='note'><?php echo tr("The sort order is critical.  If two behaviors conflict, the sort order decides which one gets to run and which one is ignored."); ?></div>
  </td>
</tr>
<tr>
  <td class="bars">
    <?php echo tr("Field to change"); ?>*
  </td>
    <?php
         $t = "\t<td class='bars'>";
         $te = "</td>\n";
...
<tr>
  ...
  <?php
    ...
    ?>
    <div class='note'><?php echo tr("If the behavior runs, the field will be 
    disabled/enabled based on this checkbox"); ?></div>
  </td>
</tr>
<tr>
  <td class="bars">
    <?php echo tr("Match Type"); ?>*
  </td>
    <?php
         $t = "\t<td class='bars'>";
         $te = "</td>\n";
