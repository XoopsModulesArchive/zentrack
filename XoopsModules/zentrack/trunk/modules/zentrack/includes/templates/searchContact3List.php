...
<td width="32" height="25" valign="middle" title="<?php echo tr("ID of the agreement"); ?>">
...
<td height="25" valign="middle" title="<?php echo tr("The name of the agreement"); ?>">
<div align="center"><span style="color:<?php echo $zen->getSetting("color_title_txt"); ?>"><b><span class="small"><?php echo tr("nr"); ?><?if (!empty($image)) {?>&nbsp;<IMG SRC="<?echo $imageUrl,$image ;?>" border="0"><?}?></span></b></span></div>
</td>

<td height="25" valign="middle" title="<?php echo tr("The company where the agreement runs"); ?>">
...
<td height="25" valign="middle" title="<?php echo tr("Title of the agreement"); ?>">
...
<td height="25" valign="middle" title="<?php echo tr("The Expiration Date"); ?>">
<div align="center"><span style="color:<?php echo $zen->getSetting("color_title_txt"); ?>"><b><span class="small"><?php echo tr("Expiration Date"); ?><?if (!empty($image)) {?>&nbsp;<IMG SRC="<?echo $imageUrl,$image ;?>" border="0"><?}?></span></b></span></div>
</td>
...
$link  = "$rootUrl/agreement.php";
   ...
   foreach($tickets as $t) {    
      ...
      ?>
   <tr  class='priority1' onclick='ticketClk("<?php echo $link?>?id=<?php echo $t["agree_id"]?>")' 
   ...
   <?php echo $zen->showDate($contact["dtime"]); ?>
   </td>
   </tr>       
   <?php
   } 
