...
?>
<div class='borderBox'>
  <div class='borderLabel'><span><?php echo uptr("Log History"); ?></span></div>
  <form>
  <input type='checkbox' id='systemLogFilterCheckbox' value='1' onclick='toggleLogs(this.checked);'>
  <label for="systemLogFilterCheckbox" title="<?php echo $hotkeys->tt("Show All Logs"); ?>"><?php echo $hotkeys->ll("Show All Logs");?></label>
  <span class='note'>
  &nbsp;&nbsp;&nbsp;&nbsp;<?php echo tr("Log Entries: ").$num_logs?>
  &nbsp;&nbsp;&nbsp;&nbsp;<?php echo tr("Hours Worked: ").$total_hours?>
  </span></form>
  <div id='logSet' class='borderContent'><?php echo $log_text?></div>
</div>
<br>
