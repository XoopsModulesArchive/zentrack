...
<form name='reopenForm' method="post" action="<?php echo $SCRIPT_NAME?>">
<input type="hidden" name="id" value="<?php echo $id?>">
<input type="hidden" name="actionComplete" value="1">

<table class='formTable' cellpadding="4" cellspacing="1" border="0">
<tr>
 <td colspan='2' class='subTitle'><?php echo tr("Reopen Ticket"); ?>
   &nbsp;&nbsp;
   <span class="note">(<?php echo tr("Reopen ticket to continue work"); ?>)</span>
 </td>
</tr>
<tr>
  <td class="bars">
     <?php echo $hotkeys->ll("Comments or Instructions"); ?>
	   <br><span class="note">(<?php echo tr("required"); ?>)</span>
  </td>
  <td class='bars'>
