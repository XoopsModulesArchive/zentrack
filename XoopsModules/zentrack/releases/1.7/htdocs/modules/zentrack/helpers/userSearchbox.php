...
<form method='post' action='<?php echo $rootUrl?>/helpers/userSearchbox.php'>
<?php if( $onechoice ) { ?>
...
<tr>
  ...
  <td class='bars'><input type='text' name='search_param[user_id]' size='12' 
	maxlength='10' value='<?php echo $zen->ffv($search_param["user_id"]); ?>'></td>
</tr>
<tr>
  <td class='bars'><?php echo tr("Last Name"); ?></td>
  <td class='bars'><input type='text' name='search_param[lname]' 
	size='22' maxlength='20' value='<?php echo $zen->ffv($search_param["lname"]); ?>'><td>
</tr>
<tr>
  <td class='bars'><?php echo tr("First Name"); ?></td>
  <td class='bars'><input type='text' name='search_param[fname]' 
	size='22' maxlength='20' value='<?php echo $zen->ffv($search_param["fname"]); ?>'></td>
</tr>
<tr>
...
<form action='<?php echo $rootUrl?>/helpers/userSearchbox.php' method='post' 
    name='helperForm'>
<?php
