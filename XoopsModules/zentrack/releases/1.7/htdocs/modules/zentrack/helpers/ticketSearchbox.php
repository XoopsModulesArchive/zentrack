...
<form method='post' action='<?php echo $rootUrl?>/helpers/ticketSearchbox.php'>
...
<form action='<?php echo $rootUrl?>/helpers/ticketSearchbox.php' method='post' name='helperForm'>
<?php
