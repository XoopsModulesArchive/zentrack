...
if ( file_exists(XOOPS_ROOT_PATH."/modules/zentrack/language/".$GLOBALS['xoopsConfig']['language']."/modinfo.php") ) {
    include_once XOOPS_ROOT_PATH."/modules/zentrack/language/".$GLOBALS['xoopsConfig']['language']."/modinfo.php";
} else {
