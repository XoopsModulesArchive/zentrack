...
<tr>
  <td class='cell'>
    ...
    <p>A <?php echo tr('Bin'); ?> (discussed in the previous section) is an example of
    a data type.
    
    <p>Data types can be maintained by going to 
      <b><?php echo tr('Admin'); ?> -&gt; <?php echo tr('Data Types'); ?></b> and choosing the appropriate
      data type to edit.
      
    <p>The '<?php echo tr('Order'); ?>' column can be used to control the order in which
...
<tr>
  <td class='cell'>
    ...
    bin to something more useful or by unchecking the '<?php echo tr('Active'); ?>' 
