...
?>
  <br>
  <blockquote>
  <span class='bigBold'>About <?php echo $zen->getSetting("system_name"); ?></span>
   
  <p><?php echo $zen->getSetting("system_name"); ?> is an open source variant of the 
     <a href='http://sourceforge.net/projects/zentrack'>zenTrack project</a>. It
     is protected under the <a href='<?php echo $helpUrl?>/gpl.php'>GPL 2.0 License</a>.</p>
