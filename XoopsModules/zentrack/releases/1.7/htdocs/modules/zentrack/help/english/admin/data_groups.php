...
<tr>
  <td class='cell'>
    ...
    <br><b><?php echo tr('Admin'); ?> -&gt; 
           <?php echo tr('Settings Administration'); ?> -&gt;
           <?php echo tr('Edit Data Groups'); ?></b></p>
  </td>    
</tr>
<tr>
...
<tr>
  <td class='cell'>  
    ...
    <tr>
      <td class='bars'><?php echo tr('Table Name'); ?></td>
      <td class='bars'>
    ...
    <tr>
      <td class='bars'><?php echo tr('Group Name'); ?></td>
      <td class='bars'>
    ...
    <tr>
      <td class='bars'><?php echo tr('Eval Type'); ?></td>
      <td class='bars'>
        Use '<?php echo tr('Matches'); ?>' to select a list of entries from a database or
        to manually type in choices.
        
        <p>Use <?php echo tr('Javascript'); ?> to enter javascript code which will create
        the list of entries.
      </td>
    </tr>
    <tr>
      <td class='bars'><?php echo tr('Eval Script'); ?></td>
      <td class='bars'>
        This is only active when the <?php echo tr('Eval Type'); ?> is set to <?php echo tr('Javascript'); ?>.
...
<tr>
  <td class='cell'>
    ...
    <?php echo tr('Table Name'); ?> field.  Once the data group is created, you may
    click on the <?php echo tr('Entries'); ?> link to select items from a list of
    valid entries.</p>
...
<tr>
  <td class='cell'>
    <p>A custom list is created by selecting the '<?php echo tr('Custom'); ?>' option
    from the <?php echo tr('Table Name'); ?> field and '<?php echo tr('Matches'); ?>' from the
    <?php echo tr('Eval Type'); ?> field.
    
    <p>Once the data group is created, clicking on the 
    <?php echo tr('Entries'); ?> link will produce a menu where you
...
<tr>
  <td class='cell'>
    ...
    <p>Javascript lists are created by selecting the '<?php echo tr('Custom'); ?>' option
    from the <?php echo tr('Table Name'); ?> field and '<?php echo tr('Javascript'); ?>' from the
    <?php echo tr('Eval Type'); ?> field.</p>
    
    <p>You will not use the <?php echo tr('Entries'); ?> link with Javascript lists.
