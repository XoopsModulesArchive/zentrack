...
{
  location.href ="<?php echo $zen->ffv($SCRIPT_NAME)."?id=".$id ?>&company_id="+variable+"&setmode=<?php echo $zen->ffv($page_mode); ?>";
}
</script>

<form method='post' action='<?php echo $zen->ffv($SCRIPT_NAME); ?>' name='notifyAddForm'>
...
<tr>
 <td class='subTitle' colspan='2'>
   <?php echo tr("Add Notify Recipients"); ?>
 </td>
</tr>
<tr>
  <td class="bars bold">
     <?php echo $hotkeys->ll("Enter Registered Users"); ?>
  </td>
</tr>
<tr>
  <td class='bars'>
...
<tr>
  <td class="bars bold">
     <?php echo $hotkeys->ll("Add an Unregistered User"); ?>
  </td>
</tr>
<tr>
  <td class='bars'>
    ...
    <tr>
      ...
      <td class='bars'>
        <input type='text' name='unreg_name' size='20' maxlength='255' 
               value='<?php echo $zen->ffv($unreg_name); ?>'>
      </td>
      <td class='bars'>
        <?php echo tr("Email"); ?>
      </td>
      <td class='bars'>
        <input type='text' name='unreg_email' size='20' maxlength='255' 
               value='<?php echo $zen->ffv($unreg_email); ?>'>
      </td>
    </tr>
    </table>
  </td>
...
<tr>
  <td class="bars bold">
     <?php echo $hotkeys->ll("Add a Contact"); ?>
  </td>
</tr>
<tr>
<td class='bars'>
