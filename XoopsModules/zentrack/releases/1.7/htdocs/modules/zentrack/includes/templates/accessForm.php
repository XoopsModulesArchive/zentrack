...
<form method="post" action="<?php echo $SCRIPT_NAME?>" name="accessForm">
<input type="hidden" name="more" value="<?php echo  strip_tags($more) ?>">
<input type="hidden" name="user_id" value="<?php echo  strip_tags($user_id) ?>">
<input type="hidden" name="TODO" value="">
<blockquote>
<table width="300" cellpadding="5">
<tr>
  <td colspan="3" class="titleCell" align="center" height="20">
    <b><?php echo tr("Set Access for ?",array($zen->formatName($user_id))); ?></b>
  </td>
</tr>
<tr>
  <td class='subTitle'><?php echo tr("Bin Name"); ?></td>
  <td class='subTitle'><?php echo tr("Level"); ?></td>
  <td class='subTitle'><?php echo tr("Role"); ?></td>
</tr>
...
<?php if( is_array($userBins) && count($userBins) ) { ?>
   <?php echo tr("Press MORE to add more custom fields"); ?>
    <br>
<?php } ?>
    <?php echo tr("Press LESS to remove blank fields"); ?>
    <br>
    <?php echo tr("Press Update to save changes"); ?>
    <br>
    <?php echo tr("Press Reset to return to users existing values"); ?>
  </td>
</tr>
<tr>
  <td class="bars" colspan="3">
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="submit" value="<?php echo tr("Update"); ?>" class="submit" onClick="return setTodo('Update')">
    &nbsp;&nbsp;&nbsp;&nbsp;
   <input type="submit" value="<?php echo tr("Reset"); ?>" class="submit" onClick="return setTodo('RESET')">
  </td>
</tr>
</table>
</blockquote>
