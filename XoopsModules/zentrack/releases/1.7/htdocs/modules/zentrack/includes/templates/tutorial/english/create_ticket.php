...
<p>The New Ticket screen can be found by clicking on <?php echo tr('Tickets'); ?> in the
nav menu.  This will expand to show the '<?php echo tr('Create new'); ?>' link.  Click on
...
<a href='<?php echo $helpUrl?>/users/tickets.php'><?php echo $usersTOC['tickets.php']?></a>
section of the User's Manual</p>

<ul>
<p><b><?php echo tr('Project'); ?></b>: Allows you to assign this ticket to an
existing project.  <?php echo tr('Projects'); ?> are discussed at length in the next 
section of the tutorial.

<p><b><?php echo tr('Title'); ?></b>: The name of this ticket.  It is best to try and
...
<p><b><?php echo tr('Type'); ?></b>: The type of issue this ticket represents.  This
is used to identify the type of work or task that will be done to complete
the issue.

<p><b><?php echo tr('Priority'); ?></b>: The level of importance given to this issue.  It
...
<p><b><?php echo tr('Start Date'); ?> and <?php echo tr('Deadline'); ?></b>: The start date and deadline
fields are used to indicate when work should commence on an issue and what
the target date for completion is.

<p><b><?php echo tr('Estimated Hours to Complete'); ?></b>: The length of time expected
to complete this project.  This can be set later if it is not known yet.

<p><b><?php echo tr('Testing Required'); ?> and <?php echo tr('Approval Required'); ?></b>:  If checked,
...
<p><b><?php echo tr('Description'); ?></b>:  Probably the single most important element
