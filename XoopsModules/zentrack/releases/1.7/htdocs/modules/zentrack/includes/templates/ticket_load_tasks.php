...
?>
  ...
  <tr>
     <td width='100%'>&nbsp;</td>
     <td align="right">
     <form style='display:inline' name='newTicketHotkey' action="<?php echo $rootUrl?>/newTicket.php">
     <input type="hidden" name="project_id" value="<?php echo $zen->checkNum($id); ?>">
     <?php renderDivButtonFind('Add Ticket to Project', 150); ?>
     </form>
     </td>
     <td align='left'>
     <form style='display:inline' name='newProjectHotkey' action="<?php echo $rootUrl?>/newProject.php">
     <input type="hidden" name="project_id" value="<?php echo $zen->checkNum($id); ?>">
