...
<tr>
  <td colspan="2" width="640" class="titleCell" align="center">
     <?php echo tr("Search For Logs"); ?>
  </td>
</tr>

<tr>
  <td colspan="2" class="subTitle">
    <?php echo tr("By Text Match"); ?>
  </td>
</tr>
<tr>
  <td class="bars">
     <?php echo tr("Containing"); ?>
  </td>
  <td class="bars">
...
<tr>
  <td class="bars">
     <?php echo tr("Maximum Age"); ?>
  </td>
  <td class="bars">
   <input type="text" name="search_date" 
      value="<?php echo strip_tags($search_date); ?>" size="4" maxlength="4">
