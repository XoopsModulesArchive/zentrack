...
<form method="post" name="<?php echo $form_name?>" action="<?php echo $formDest?>" onSubmit='return validateTicketForm(this)'>
<tr>
  <td colspan="2" width="640" class="subTitle" align="center">
     <?php echo tr("$ucfirst Information"); ?>
  </td>
</tr>
<?php
  ///////////////////////////////////////
...
<tr>
  <td class="bars">
    <?php echo tr("Edit Reason"); ?><br>
    <span class='note'>(<?php echo tr("Required"); ?>)</note>
  </td>
  <td class="bars">
<?php
...
<tr>
  <td colspan="2" class="subTitle">
   <input type="submit" value=" <?php echo tr(($td)?"Save":"Create"); ?> " class="submit">
  </td>
</tr>
</table>
</form>
