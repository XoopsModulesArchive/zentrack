...
?>
<form method='post' action='<?php echo $SCRIPT_NAME?>' name='viewPickForm'>
<input type='hidden' name='view' value='<?php echo $zen->ffv($view); ?>'>
<table class='microTable'><tr><td width='150' valign='top'>
<p class='heading'><?php echo tr("Edit Field Map"); ?></p>
<p class='note'><?php
...
<p class='note'><?php echo tr("Do not switch views without saving changes!"); ?></p>


</form>
<form method='post' action='<?php echo $SCRIPT_NAME?>' name='fieldMapForm'>
<?php
$fcount = 0;
...
<?php if( $view ) { ?>
<input type='submit' value='<?php echo uptr('save'); ?>' onClick="return setTodo('save');">
&nbsp;
...
<table cellpadding='4' cellspacing='1' class='cell' border='0'>
  <tr toofar="toofar"><td colspan='10' align='center' class='subTitle'><?php echo tr("Properties for ?", $view); ?></td></tr>
<?php
...
<tr toofar="toofar">
  <td class='subTitle' align='center' colspan='10'>
    <b><?php echo tr("Fields for ?", $view); ?></b>
  </td>
</tr>
<?php
...
<tr toofar="toofar" id="beforeFirstRow">
  <td class='headerCell' align='center'><b><?php echo tr("Options"); ?></b></td>
  <td class='headerCell' align='center'><b><?php echo tr("Name"); ?></b></td>
  <td class='headerCell' align='center'><b><?php echo tr("Label"); ?></b></td>
  <td class='headerCell' align='center'><b><?php echo tr("Show"); ?></b></td>
  <td class='headerCell' align='center'><b><?php echo tr("Required"); ?></b></td>
  <td class='headerCell' align='center'><b><?php echo tr("Default"); ?></b></td>
  <td class='headerCell' align='center'><b><?php echo tr("Type"); ?></b></td>
  <td class='headerCell' align='center'><b><?php echo tr("Columns"); ?></b></td>
  <td class='headerCell' align='center'><b><?php echo tr("Rows"); ?></b></td>
</tr>
<?php
...
<tr id='section0' style="display:none;">
  <td class='highlight'><input type='hidden' name='orderset[section0]' value='3'><a href='#' onClick='moveRowUp(this.parentNode);return false;' border='0' alt='Move Up' title='Move Up'><img src='<?php echo $imageUrl?>/icon_arrow_up.gif' width='16' height='16' alt='Move Up' title='Move Up' border='0'></a><a href='#' onClick='moveRowDown(this.parentNode);return false;' border='0' alt='Move Down' title='Move Down'><img src='<?php echo $imageUrl?>/icon_arrow_down.gif' width='16' height='16' alt='Move Up' title='Move Up' border='0'></a><a href='#' onClick='removeRow(this);return false;' border='0' alt='Remove Section' title='Remove Section'><img src='<?php echo $imageUrl?>/icon_trash.gif' width='16' height='16' alt='Remove Section' title='Remove Section' border='0'></a></td>
