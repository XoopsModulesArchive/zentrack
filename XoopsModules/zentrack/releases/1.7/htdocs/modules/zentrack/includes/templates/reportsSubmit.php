...
<!-- SUBMIT MENU -->
<tr>
  <td class='<?php echo ($tf_options)? "titleCell" : "subTitle" ?>' colspan='3'>
    <?php echo tr("Submit Results"); ?>
  </td>
</tr>
<?php
...
?>
<tr>
  <td class='bars' colspan='3'><input type='submit' class='submit' value=' <?php echo tr("View Chart"); ?> '></td>
</tr>  
</form>
<?php
  } else {
