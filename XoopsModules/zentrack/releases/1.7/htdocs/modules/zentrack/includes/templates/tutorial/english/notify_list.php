...
<p>The notify list is located in the ticket view, under the '<?php echo tr('Notify'); ?>' tab.
...
<p>To add a new user, simply view the ticket and choose the '<?php echo tr('Notify'); ?>'
tab.  Then click on '<?php echo tr('Add Recipient'); ?>'.
