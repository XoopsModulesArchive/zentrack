...
?>
      <br>
      <p><b><?php echo tr("Edit existing behaviors or create a new one."); ?></b></p>
      ...
      <p class='error'><?php
       ...
       ?></p>
      <ul>
      <form name='behaviorForm' action='<?php echo $elnk?>' method='post'>
      <input type='hidden' name='TODO' value=''>
      <table cellpadding="4" cellspacing="1" class='cell'>
	 <tr>
	 <td class='titleCell' align='center' colspan='9'>
	   <b><?php echo tr("Edit the Behaviors"); ?></b>
	 </td>
	 </tr>
<tr>
  <td class='subTitle' width='30' align='center'><b><?php echo tr("ID"); ?></b></td>
  <td class='subTitle' align='center'><b><?php echo tr("Enabled"); ?></b></td>
  <td class='subTitle' align='center'><b><?php echo tr("Sort Order"); ?></b></td>
  <td class='subTitle' align='center'><b><?php echo tr("Behavior Name"); ?></b></td>
  <td class='subTitle' align='center'><b><?php echo tr("Match Type"); ?></b></td>
  <td class='subTitle' align='center'><b><?php echo tr("Field Name"); ?></b></td>
  <td class='subTitle' align='center'><b><?php echo tr("Group to apply"); ?></b></td>
  <td class='subTitle' align='center'><b><?php echo tr("Field State"); ?></b></td>
  <td class='subTitle' align='center'><b><?php echo tr("Actions"); ?></b></td>
</tr>
...
<tr>
  <td class="titleCell" colspan="9">
    <?php echo tr('Press NEW to create new behaviors'); ?>
    <br>
    <?php echo tr('Press DONE when you are finished'); ?>
  </td>
</tr>
      <tr>
         <td class='cell' colspan='3'>
         <input type='submit' class='submit' value='<?php echo tr('New'); ?>' onClick="return setTodo('NEW')">
         &nbsp;
         <input type='submit' class='submit' value='<?php echo tr('Done'); ?>' onClick="return setTodo('DONE')">
         </td>
      </tr>
      </table>
      </ul>
