...
<form method="post" name="ticketTabForm" action="<?php echo $actionName?>" onSubmit='return validateTicketForm(this)'>
<?php
...
<input type='hidden' name='currentMode' value='<?php echo $zen->ffv($page_mode); ?>'>

<table class='formtable' cellpadding="4" cellspacing="1" border="0">
<tr>
 <td colspan='2' class='subTitle'><?php echo tr($formTitle); ?>
...
<div class='error'><?php echo tr("Fields marked with ? are required", "<span class='bigBold'>*</span>"); ?></div>
</form>			     
<?php
