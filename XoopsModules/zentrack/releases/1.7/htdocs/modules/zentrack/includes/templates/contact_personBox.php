...
<table width='620'><tr><td>
   ...
   <table class='formtable' width='500' cellpadding="0" cellspacing="1">
    <tr>
	   <td class="subTitle" colspan="4"><p align="center"><?php echo  ucfirst($lname).", "; echo($fname)? ucfirst($fname):ucfirst($initials);?> </p></td>
	  </tr>
	  <tr>
	   <td class="headerCell" colspan="2" ><?php echo uptr("Info"); ?></td>
	   <td class="headerCell" colspan="2" width="50%"><?php echo tr("Phone"); ?></td>
	  </tr>
	  <tr>
	   <td class="bars small"><?php echo tr("Title"); ?>:</td> 
	   <td class="bars small"><?php echo $zen->fhv($jobtitle); ?></td>
	   <td class="bars small"><?php echo tr("Telephone"); ?>:</td> 	   
	   <td class="bars small"><?php echo $zen->fhv($telephone); ?></td>
	  </tr>
	  <tr>
	   <td class="bars small"><?php echo tr("Department"); ?>:</td> 
	   <td class="bars small"><?php echo $zen->fhv($t["department"]); ?></td>  
	   <td class="bars small"><?php echo tr("Mobile"); ?>:</td>  
	   <td class="bars small" width='30%'><?php echo $zen->fhv($mobiel); ?></td>
	  </tr>
	  <tr>
	   <td class="bars small"><?php echo tr("E-mail"); ?>:</td> 
	   <td class="bars small" width="30%"><?if($email){?>
      <A HREF="mailto:<?php echo $zen->ffv($email); ?>"><?php echo $zen->ffv($email); ?></A>
      <?php } else { print '&nbsp;'; } ?>
     </td> 
...
?>	  
	  <tr>
	   <td class="headerCell" colspan="4"><?php echo tr("Notes"); ?></td>  
	  </tr>
	  <tr>
	   <td class="bars small" colspan="4"><?php echo  $zen->ffvText($description) ?></td>
	  </tr>
<?php
}
?>
