...
?>
<form action="<?php echo $SCRIPT_NAME?>" name="searchForm" method='POST'>
...
<tr>
  <td colspan="2" width="640" class="titleCell" align="center">
     <?php echo tr("Search For Tickets"); ?>
  </td>
</tr>
<tr>
...
<tr>
  <td colspan="2" class="subTitle">
    <?php echo tr("Containing Text"); ?>
  </td>
</tr>
<tr>
  <td class="bars">
     <?php echo $hotkeys->ll("Containing"); ?>
  </td>
  <td class="bars">
...
<tr>
  <td colspan="2" class="subTitle">
	<?php echo tr("Click 'Search' to find results"); ?>
  </td>
</tr>
<tr>
  <td class="bars" colspan="2">
