...
<table width='60%' class='formtable' cellpadding='2' cellspacing='1'>
  <tr>
   <td class="subTitle" colspan="4"><p align="center"><?php echo $zen->ffv($contractnr); ?></p></td>
  </tr>
  <tr>
   <td class="headerCell" colspan="2" ><?php echo tr("Info"); ?></td>
   <td class="headerCell"  colspan="2" width="50%"><?php echo tr("Dates"); ?></td>
  </tr>
  <tr>
   <td class="bars small" width="20%"><?php echo tr("Title"); ?>:</td>
   <td class="bars small" width="30%"><?php echo $zen->ffv($title); ?></td>
   <td class="bars small" width="20%"><?php echo tr("Start Date"); ?>:</td>
   <td class="bars small" width="30%"><?if($stime){echo $zen->showDate($stime);}?></td>
  </tr>
  <tr>
   <td class="bars small" width="20%"><?php echo tr("Company"); ?>:</td>
   <td class="bars small" width="30%"><?php echo $name?></td>
   <td class="bars small" width="20%"><?php echo tr("Expiration Date"); ?>:</td>
...
?>
	  <tr>
	   <td class="headerCell" colspan="4"><?php echo tr("Description"); ?></td>
	  </tr>
	  <tr>
...
<tr>
	   <td class="subTitle" colspan="3"><?php echo tr("Items"); ?></td>
</tr>
<tr>
  <td class='headerCell'><?php echo tr("ID"); ?></td>
  <td class='headerCell'><?php echo tr("Name"); ?></td>
...
<?php
  foreach($items as $t) {
    ?>
    <tr class='bars'>
    <td><?php echo $t["item_id"]?></td>
    <td><?php echo $zen->ffv($t["name1"]); ?></td>
    <td><?php echo $zen->ffv($t["description1"]); ?></td>
    </tr>
    <?php
  }
}
