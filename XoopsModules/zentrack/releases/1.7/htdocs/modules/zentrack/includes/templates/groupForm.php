...
?>
      <br>
      <p><b><?php echo tr("Edit existing groups or create a new group."); ?></b></p>
      <p class='error'><?php
       ...
       ?></p>      
      <ul>
      <form name='groupForm' action='<?php echo $elnk?>' method='post'>
      <input type='hidden' name='TODO' value=''>
      <table cellpadding="4" cellspacing="1" class='cell'>
	 <tr>
	 <td class='titleCell' align='center' colspan='7'>
	   <b><?php echo tr("Data Groups"); ?></b>
	 </td>
	 </tr>
	 <tr>
           <td width="30" class='cell' align='center'><b><?php echo uptr("id"); ?></b></td>
           <td class='cell' align='center'><b><?php echo tr("Group Name"); ?></b></td>
           <td class='cell' align='center'><b><?php echo tr("Table Name"); ?></b></td>
           <td class='cell' align='center'><b><?php echo tr("Type"); ?></b></td>
           <td class='cell' align='center'><b><?php echo tr("Entries"); ?></b></td>
           <td class='cell' align='center'><b><?php echo tr("Description"); ?></b></td>
           <td class='cell' align='center'><b><?php echo tr("Actions"); ?></b></td>
	 </tr>
    <?php 
...
<tr>
  <td class="titleCell" colspan="7">
    <?php echo tr('Press NEW to create new data groups'); ?>
    <br>
    <?php echo tr('Press DONE when you have finished with the edition'); ?>
  </td>
</tr>
      <tr>
