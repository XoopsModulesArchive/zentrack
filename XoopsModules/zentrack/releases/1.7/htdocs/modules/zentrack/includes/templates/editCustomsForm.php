<?php if( !ZT_DEFINED ) { die("Illegal Access"); } ?>
      ...
      <p class='bigBold'><?php echo tr('Edit Variable Fields'); ?></p>
      ...
      <ul>
      <form name='editCustomsForm' action='<?php echo $SCRIPT_NAME?>' method='post'>
      <input type='hidden' name='TODO' value=''>
      <table cellpadding="2" cellspacing="1" class='plainCell'>
	 <tr>
	 <td class='titleCell' align='center' colspan='12'>
	   <b><?php echo tr("Edit the Available Custom Fields"); ?></b>
	 </td>
	 </tr>
	 <tr>
	 <td width="60" class='subTitle' align='center'><b><?php echo tr("Field Name"); ?></b></td>
	 <td class='subTitle' align='center'><b><?php echo tr("Field Label"); ?></b></td>
	 <td class='subTitle' align='center'><b><?php echo tr("Order"); ?></b></td>
	 <td class='subTitle' align='center'><b><?php echo tr("Default"); ?></b></td>
	 <td width="30" class='subTitle' align='center' title="<?php echo tr("Is this field required?"); ?>">
	   <b><?php echo tr("Required"); ?></b>
         </td>
	 <td width="30" class='subTitle' align='center' title="<?php echo tr("Used for projects?"); ?>">
           <b><?php echo tr("Projects"); ?></b>
         </td>
	 <td width="30" class='subTitle' align='center' title="<?php echo tr("Used for tickets?"); ?>">
	   <b><?php echo tr("Tickets"); ?></b>
         </td>
	 <td width="30" class='subTitle' align='center' title="<?php echo tr("Used for searches?"); ?>">
	   <b><?php echo tr("Searches"); ?></b>
         </td>
	 <td width="30" class='subTitle' align='center' title="<?php echo tr("Ticket lists?"); ?>">
	   <b><?php echo tr("Lists"); ?></b>
         </td>
	 <td width="30" class='subTitle' align='center' title="<?php echo tr("Show in custom tab?"); ?>">
	   <b><?php echo tr("Custom"); ?></b>
         </td>
	 <td width="30" class='subTitle' align='center' title="<?php echo tr("Show in detail tab?"); ?>">
	   <b><?php echo tr("Details"); ?></b>
         </td>
	 <td width="30" class='subTitle' align='center' title="<?php echo tr("Create new ticket window?"); ?>">
	   <b><?php echo tr("New"); ?></b>
         </td>
       </tr>
    <?php
